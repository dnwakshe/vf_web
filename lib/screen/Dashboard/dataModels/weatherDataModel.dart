...
class CurrentUnits {
  ...
  CurrentUnits({time, interval, temperature2m, windSpeed10m});
...
class Current {
  ...
  Current({time, interval, temperature2m, windSpeed10m});
...
class HourlyUnits {
  ...
  HourlyUnits({time, temperature2m, relativeHumidity2m, windSpeed10m});
